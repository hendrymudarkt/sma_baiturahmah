...
<section class="content-header">
	<div class="container-fluid">
		<div class="row mb-2">
			<div class="col-sm-6">
				<h1>Dokumen Eksternal</h1>
			</div>
			<div class="col-sm-6">
				<ol class="breadcrumb float-sm-right">
					<li class="breadcrumb-item"><a href="#">Dokumen Laboratorium</a></li>
					<li class="breadcrumb-item active">Dokumen Eksternal</li>
				</ol>
			</div>
		</div>
	</div><!-- /.container-fluid -->
		...
		<div class="col-md-12">
			<div class="card">
				<div class="card-header">
					<h3 class="card-title">Data Dokumen Eksternal</h3>
				</div>
				<!-- /.card-header -->
				<div class="card-body">
...
<script type="text/javascript">
	$(document).ready(function () {
		...
		function tampil_data_pengguna() {
			...
			$.ajax({
				type: 'GET',
				url: '<?php echo site_url("dokumen/data_ed_dlab") ?>',
				async: false,
				dataType: 'json',
				success: function (data) {
					...
					for (i = 0; i < data.length; i++) {
						...
						<?php } else { ?>
							...
							data[i].id_dokumen +
							'" class="btn btn-icon btn-sm btn-primary"><i class="far fa-eye"></i> Download</a> </td>' +
							'<td>' + data[i].owner + '</td>' +
							'</tr>';
						<?php } ?>
					}
