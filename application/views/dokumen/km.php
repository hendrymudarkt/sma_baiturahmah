...
<section class="content-header">
	<div class="container-fluid">
		<div class="row mb-2">
			<div class="col-sm-6">
				<h1>Katentuan dan Manual</h1>
			</div>
			<div class="col-sm-6">
				<ol class="breadcrumb float-sm-right">
					<li class="breadcrumb-item"><a href="#">Dokumen Manual Mutu</a></li>
					<li class="breadcrumb-item active">Ketentuan dan Manual</li>
				</ol>
			</div>
		</div>
	</div><!-- /.container-fluid -->
		...
		<div class="col-md-12">
			<div class="card">
				<div class="card-header">
					<h3 class="card-title">Data Ketentuan dan Manual</h3>
				</div>
				<!-- /.card-header -->
				<div class="card-body">
...
<script type="text/javascript">
	$(document).ready(function () {
		...
		function tampil_data_pengguna() {
			...
			$.ajax({
				type: 'GET',
				url: '<?php echo site_url("dokumen/data_km") ?>',
				async: false,
				dataType: 'json',
