...
<section class="content-header">
	<div class="container-fluid">
		<div class="row mb-2">
			<div class="col-sm-6">
				<h1>Integrated Manual System</h1>
			</div>
			<div class="col-sm-6">
				<ol class="breadcrumb float-sm-right">
					<li class="breadcrumb-item"><a href="#">Integrated Manual System</a></li>
				</ol>
			</div>
		</div>
	</div><!-- /.container-fluid -->
		...
		<div class="col-md-12">
			<div class="card">
				<div class="card-header">
					<h3 class="card-title">Integrated Manual System</h3>
				</div>
				<!-- /.card-header -->
				<div class="card-body">
				...
				<div class="modal-body">
					<input type="hidden" name="id" id="id">
						...
						<select name="kategori2" id="kategori2" class="form-control">
                            ...
                            <option value="Dokumen IMS">Dokumen IMS</option>
							<option value="Dokumen SMK3 PP 2012">Dokumen SMK3 PP 2012</option>
						</select>
					
						<label for="jenis_dokumen2">Jenis Dokumen</label>
						<select name="jenis_dokumen2" id="jenis_dokumen2" class="form-control">
							<option value="NULL">...</option>
							<option value="Ketentuan dan Manual">Ketentuan dan Manual</option>
...
<script type="text/javascript">
	$(document).ready(function () {
		...
		function tampil_data_pengguna() {
			...
			$.ajax({
				type: 'GET',
				url: '<?php echo site_url("dokumen/data_ims") ?>',
				async: false,
				dataType: 'json',
				success: function (data) {
					...
					for (i = 0; i < data.length; i++) {
						...
						html += '<tr>' +
							...
							'<a href="javascript:;" data="' +
							data[i].id_dokumen +
							'" class="btn btn-icon btn-sm btn-danger item_hapus"><i class="far fa-trash-alt"></i></a>' + ' <a href="' + urll + data[i].file + '" data="' +
							data[i].id_dokumen +
						...
						<?php } else { ?>
							...
							data[i].id_dokumen +
							'" class="btn btn-icon btn-sm btn-primary"><i class="fa fa-eye"></i> Download</a> </td>' +
							'</tr>';
						<?php } ?>
					}
					$('#show_data').html(html);
